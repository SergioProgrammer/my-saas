...
const plans = [
  {
    ...
    icon: <FaCrown className="w-8 h-8 text-gray-700" />,
    color: "bg-gray-100",
    cta: "Empieza gratis",
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "o solo citas en Calendar ",
      "o notificaciones en WhatsApp ",
    ],
    icon: <FaEnvelope className="w-8 h-8 text-gray-700" />,
    color: "bg-gray-100",
    cta: "Elegir plan",
  },
  {
    ...
    features: [
      "Ejemplo: Calendar + Recordatorios por correo",
      "o WhatsApp + Gmail",
      "Soporte prioritario",
    ],
    icon: <FaCalendarAlt className="w-8 h-8 text-gray-700" />,
    color: "bg-gray-100",
    cta: "Elegir plan",
  },
  {
    ...
    features: [
      "Ejemplo: Gmail + Calendar + WhatsApp",
      "Reportes automáticos incluidos",
      "Soporte premium",
    ],
    icon: <FaWhatsapp className="w-8 h-8 text-gray-700" />,
    color: "bg-gray-100",
    cta: "Elegir plan",
  },
  {
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {plans.map((plan, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col justify-between bg-[#faf9f6] rounded-3xl shadow-lg hover:shadow-2xl transition p-10 text-left"
            >
              <div>
                <div
                  className={`w-16 h-16 flex items-center justify-center rounded-2xl ${plan.color} mb-6`}
                >
                  {plan.icon}
                </div>
